...
@Controller
@SessionAttributes({"User","Employee","Supervisor"})
...
public class SupervisorController {
	 ...
	 @Autowired
	  ...
	  /*  
	    ...
	    @RequestMapping(value="/maintainsupervisor", method=RequestMethod.DELETE)
		public void deleteEmployee(String username, Model model) {
	    		 supervisorStore.deleteByUsername(username);
	    		 showSupervisorRegister(model);
